...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['form_name'] != '' AND $_POST['form_email'] != '' AND $_POST['form_phone'] != '' AND $_POST['form_option'] != '' AND $_POST['form_message'] != '') {
        ...
        if( $botcheck == '' ) {
			...
			$body = $name.' '.$email.' '.$phone.' '.$option.' '.$message.' '.$referrer;
